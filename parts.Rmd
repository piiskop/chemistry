...
#### Mittealuseline metall ja hapnik

3. 2 * Mg + O~2~ -> 2 * MgO

Reaktsioon toimub kõrge temperatuuriga.

4. 4 * Al + 3 * O~2~ -> 2 * Al~2~O~3~
...
1. 2 * Li + 2 * H~2~O -> Li~2~O + H~2~O + H~2~ -> 2 * LiOH + H~2~

2. 2 * Na + 2 * H~2~O -> Na~2~O + H~2~O + H~2~ -> 2 * NaOH + H~2~

Selles reaktsioonis eraldub soojus, mis põletab vesiniku ära.

3. Mg + 2 * H~2~O -> MgO + H~2~O + H~2~ -> Mg(OH)~2~ + H~2~

See reaktsioon toimub kõrge temperatuuriga.

4. 2 * Al + 3* H~2~O -> Al~2~O~3~ + 3 * H~2~
...
See reaktsioon tiomub rohke hapnikuga.

2. 4 * P + 5 * O~2~ -> P~4~O~10~

3. S + O~2~ -> SO~2~

4. 2 * S + 3* O~2~ (erinev *9*'st) -> 2 * SO~3~

### Vesi ja mittemetall

1. H~2~O + S -> 

### Vesi ja happeline oksiid
...
1. 2 * Na + 2 * HCl -> 2 * NaCl + H~2~

2. Cu + HCl

Reaktsioon ei toimu, sest vesinik on tugevam ja vask ei tõrju vesinikku välja.

3. 3 * Cu + 8 * HNO~3~ -> 3 * Cu(NO~3~)~2~ + 4 * H~2~O + 2 * NO

Vask siiski reageerib oksügeeni sisaldava happega.

4. Cu + 2 * H~2~SO~4~ -> CuSO~4~ + 2 * H~2~O + SO~2~
