...
3. $H_2SO_4 (väävelhape) + 2 * K -> K_2SO_4 + H_2$
...
3. $2 \cdot KOH + H_2SO_4 \rightarrow \underbrace{K_2SO_4}_{kaaliumsulfaat} + 2 \cdot \underbrace{H_2O}_{vesi}$

4. 3 * NaOH + H~3~PO~4~ -> Na~3~PO~4~ + 3 * H~2~O

5. $3 \cdot Ca(OH)_2 + 2 \cdot H_3PO_4 \rightarrow \underbrace{Ca_3(PO_4)_2}_{kaltsiumfosfaat} + 6 \cdot \underbrace{H_2O}_{vesi}$
...
$H_2SO_4 \rightarrow 2 \cdot H + S + 4 \cdot O$
