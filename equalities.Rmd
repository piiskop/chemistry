...
$$HCl \rightarrow HNO_3 \rightarrow H_2SO_4$$
...
1.  $\mathrm{Cl + Cl \rightarrow Cl_}2$
...
9.  $\mathrm{Zn + 2H_2S^{VI}O_4^{-II} → \text{(arvestada, et tekib happele vastav sool, SO_2 ja vesi)}Zn^{II}S^{VI}O_4^{-II} + S^{IV}O_2^{-II} + 2H_2O}$
...
6. $\mathrm{H_2SO_4 + 2 \cdot NaOH \rightarrow 2 \cdot H_2O + Na_2SO_4}$

7. $\mathrm{2 \cdot KOH + H_2SO_4 \rightarrow \underbrace{K_2SO_4}_{kaaliumsulfaat} + 2 \cdot \underbrace{H_2O}_{vesi}}$

8. $\mathrm{H_2SO_4 + Ca(OH)_2 \rightarrow CaSO_4 + 2 \cdot H_2O}$

9.  $\mathrm{3NaOH + H_3PO_4 \rightarrow Na_3PO_4 + 3H_2O}$
...
10. $\mathrm{2 \cdot H_3PO_4 + 3 \cdot Mg(OH)_2 \rightarrow 6 \cdot H_2O + Mg_3(PO_4)_2}$

11. $\mathrm{3 \cdot Ca(OH)_2 + 2 \cdot H_3PO_4 \rightarrow \underbrace{Ca_3(PO_4)_2}_{kaltsiumfosfaat} + 6 \cdot \underbrace{H_2O}_{vesi}}$

12. $\mathrm{H_2CO_3 + 2 \cdot NaOH \rightarrow Na_2CO_3 + 2 \cdot H_2O}$

13.  $\mathrm{Cu(OH)_2 + H_2S → CuS + 2H_2O}$

     Reaktsioon toimub alati.

13. $\mathrm{Be(OH)_2 + 2HNO_3 \rightarrow Be(NO_3)_2 + 2H_2O}$

14. $\mathrm{Be(OH)_2 + 2NaOH \rightarrow Na_2 \cdot Be(OH)_4}$
...
5. $\mathrm{(NH_4)_2SO_4 + Mg(OH)_2 \rightarrow MgSO_4 + 2NH_3 + 2H_2O}$

6. Ca(OH)~2~ + K~2~SO~4 -> 

7.  $\mathrm{Zn(OH)_2 + NaCl →}$
...
5.  $\mathrm{NaCl \rightarrow Na^+ + Cl^-}$
    ...
    ![Positiivselt laetud osakesed liituvad negatiivselt laetud osakestega ja vastupidi.](nacl-vees.svg)
